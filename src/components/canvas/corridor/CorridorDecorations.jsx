                ...
                return (
                    <group key={`light-${i}`} position={[0, ceilingY, light.z]}>
                        ...
                        <mesh position={[0, -0.03, 0]}>
                            ...
                            <meshBasicMaterial attach="material-0" color="#6B665F" />
                            <meshBasicMaterial attach="material-1" color="#6B665F" />

                            {/* Top (Hidden) */}
                            <meshBasicMaterial attach="material-2" color="#5A5550" />
                            ...
                            */}
                            ...
                            <meshBasicMaterial color="#6B665F" attach="material-4" map={lampSideTexture} />
                            <meshBasicMaterial color="#6B665F" attach="material-5" map={lampSideTexture} />
                        </mesh>
