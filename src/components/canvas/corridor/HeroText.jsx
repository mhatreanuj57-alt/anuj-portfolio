 ...
 * - ANUJ in Rubik Scribble font (splits into letters during scroll)
 * - Creative engineer in Cabin Sketch font (also splits)
...
const HeroText = ({ position = [0, 0.3, 0] }) => {
    ...
    // Letter positions for ANUJ split effect
    const letters = useMemo(() => [
        { char: 'A', baseX: -1.0, splitDir: -1.6, delay: 0 },
        { char: 'N', baseX: -0.38, splitDir: -0.6, delay: 0 },
        { char: 'U', baseX: 0.23, splitDir: 0.6, delay: 0 },
        { char: 'J', baseX: 0.95, splitDir: 1.8, delay: 0 },
    ], []);
    ...
    return (
        <group ref={groupRef} position={position} scale={[scale, scale, 1]}>
            {/* ANUJ Letters - Rubik Scribble font with fade-in animation */}
