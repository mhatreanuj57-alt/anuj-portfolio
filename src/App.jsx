...
// Gradient sky background (rich sky blue top → soft horizon blue bottom)
const GradientSkyBackground = () => {
  ...
  useEffect(() => {
    ...
    gradient.addColorStop(0, '#4A90D9');   // Rich Sky Blue (top)
    gradient.addColorStop(1, '#B8D4E8');   // Soft Horizon Blue (bottom)
