...
const STORY_MILESTONES = [
    { id: 'intro', position: [0, 0, -15], type: 'intro', title: 'ANUJ', subtitle: '< creative engineer />' },
    { id: 'awards', position: [0, 0, -55], type: 'awards', title: 'CERTIFICATIONS', subtitle: '27+ Certifications Earned' },
    { id: 'journey', position: [0, 0, -95], type: 'journey', title: 'JOURNEY', subtitle: 'BTech CSE (AI & ML) @ CSMU, Navi Mumbai' },
    ...
    return (
        <group ref={roomRef} position={[0, 0, -25]}>
            ...
            <mesh position={[0, 0, -200]}>
                ...
                <meshBasicMaterial color="#E0FFFF" side={THREE.DoubleSide} />
            </mesh>
        </group>
    );
};
