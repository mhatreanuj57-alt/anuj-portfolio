        ...
        <group position={[pivotX, position[1], position[2]]} visible={isSecretDoorVisible}>
            ...
            <group ref={groupRef}>
                ...
                <mesh position={[wallOffsetX, 0, 0]} geometry={wallWithHoleGeometry}>
                    <meshBasicMaterial color="#DDD6CC" map={wallTexture} side={THREE.DoubleSide} />
                </mesh>
                ...
                <mesh position={[wallOffsetX - 1.4, -CORRIDOR_HEIGHT / 2 + 0.075, 0.02]}>
                    ...
                    <meshBasicMaterial color="#5C4635"
                        map={doorBbTexLeft}
                        side={THREE.DoubleSide}
                    />
                </mesh>
                ...
                <group position={[wallOffsetX, -0.4, 0]}>
                    ...
                    <group position={[0, doorHeight / 2 + 0.45, 0.08]}>
                        ...
                        */}
                        <mesh>
                            ...
                            <meshBasicMaterial color="#DDD6CC"
                                map={signTexture}
                                transparent={true}
                                alphaTest={0.1}
                            />
                    ...
                    <group ref={doorRef} position={[doorPivotX, 0, 0.01]}>
                        ...
                        >
                            ...
                            <meshBasicMaterial color="#DDD6CC" transparent={true} opacity={0} depthWrite={false} />
                        </mesh>
