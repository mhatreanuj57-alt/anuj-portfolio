...
const AWARDS_DATA = {
    featured: {
        ...
        items: [
            { label: 'Featured - Awwwards', date: 'May 2025', image: '/textures/about/SOTY.webp', url: 'https://awwwards.com' },
            { label: 'Featured - CSS Design Awards', date: 'June 2025', image: '/textures/about/SOTY.webp', url: 'https://cssdesignawards.com' },
        ],
        platformConfig: {
            label: 'HONOR',
            color: '#1a1a1a',
    ...
    certificates: {
        ...
        title: 'CERTIFICATES',
        items: [
            { label: 'AI Fluency Educators', date: '2025', image: '/textures/about/certs/ai-fluency-educators-cert.png' },
            { label: 'AI Fluency Students', date: '2025', image: '/textures/about/certs/ai-fluency-students-cert.png' },
            { label: 'AI Fundamentals', date: '2025', image: '/textures/about/certs/ai-fundamentals-cert.png' },
            { label: 'Case Block World', date: '2025', image: '/textures/about/certs/case-block-world-cert.png' },
            { label: 'Claude AI Fluency', date: '2025', image: '/textures/about/certs/claude-ai-fluency-cert.png' },
            { label: 'Claude API', date: '2025', image: '/textures/about/certs/claude-api-cert.png' },
            { label: 'Claude', date: '2025', image: '/textures/about/certs/claude-cert.png' },
            { label: 'Claude Code 101', date: '2025', image: '/textures/about/certs/claude-code-101-cert.png' },
            { label: 'Claude Code In Action', date: '2025', image: '/textures/about/certs/claude-code-in-action-cert.png' },
            { label: 'Claude CoWork', date: '2025', image: '/textures/about/certs/claude-cowork-cert.png' },
            { label: 'Claude Platform 101', date: '2025', image: '/textures/about/certs/claude-platform-101-cert.png' },
            { label: 'IBM Data Science 101', date: '2025', image: '/textures/about/certs/ibm-data-science-101-cert.png' },
            { label: 'IBM Data Science', date: '2025', image: '/textures/about/certs/ibm-data-science-cert.png' },
            { label: 'IBM DataViz', date: '2025', image: '/textures/about/certs/ibm-dataviz-cert.png' },
            { label: 'IBM GenAI Essentials', date: '2025', image: '/textures/about/certs/ibm-genai-essentials-cert.png' },
            { label: 'IBM Python', date: '2025', image: '/textures/about/certs/ibm-python-cert.png' },
            { label: 'MCP Advanced', date: '2025', image: '/textures/about/certs/mcp-advanced-cert.png' },
            { label: 'MCP Intro', date: '2025', image: '/textures/about/certs/mcp-intro-cert.png' },
        ],
        platformConfig: {
            label: 'CERT',
            color: '#1a1a1a',
    ...
    badges: {
        ...
        title: 'BADGES',
        items: [
            { label: 'Google Intro GenAI', date: '2025', image: '/textures/about/certs/google-intro-genai-badge.png' },
            { label: 'Google Intro LLM', date: '2025', image: '/textures/about/certs/google-intro-llm-badge.png' },
            { label: 'IBM Data Science', date: '2025', image: '/textures/about/certs/ibm-data-science-badge.png' },
            { label: 'IBM GenAI Essentials', date: '2025', image: '/textures/about/certs/ibm-genai-essentials-badge.png' },
            { label: 'IBM Prompt', date: '2025', image: '/textures/about/certs/ibm-prompt-badge.png' },
            { label: 'IBM Granite Sticker', date: '2025', image: '/textures/about/certs/ibm-granite-sticker.png' },
            { label: 'IBM Granite Classify', date: '2025', image: '/textures/about/certs/ibm-granite-classify-sticker.png' },
            { label: 'IBM LLM Sticker', date: '2025', image: '/textures/about/certs/ibm-llm-sticker.png' },
        ],
        platformConfig: {
            label: 'BADGE',
            color: '#1a1a1a',
    ...
    sphere3d: {
        ...
        items: [
            ...
            { label: 'IBM Python', date: '2025', image: '/textures/about/certs/ibm-python-cert.png' },
            { label: 'Claude API', date: '2025', image: '/textures/about/certs/claude-api-cert.png' },
            { label: 'IBM Prompt Badge', date: '2025', image: '/textures/about/certs/ibm-prompt-badge.png' },
            { label: 'AI Fundamentals', date: '2025', image: '/textures/about/certs/ai-fundamentals-cert.png' },
            { label: 'Claude CoWork', date: '2025', image: '/textures/about/certs/claude-cowork-cert.png' },
            { label: 'IBM GenAI Essentials', date: '2025', image: '/textures/about/certs/ibm-genai-essentials-cert.png' },
            { label: 'Google Intro LLM', date: '2025', image: '/textures/about/certs/google-intro-llm-badge.png' },
            ...
            { label: 'IBM DataViz', date: '2025', image: '/textures/about/certs/ibm-dataviz-cert.png' },
            { label: 'MCP Intro', date: '2025', image: '/textures/about/certs/mcp-intro-cert.png' },
            { label: 'Claude Cert', date: '2025', image: '/textures/about/certs/claude-cert.png' },
            { label: 'IBM Data Science 101', date: '2025', image: '/textures/about/certs/ibm-data-science-101-cert.png' },
            { label: 'Claude Platform 101', date: '2025', image: '/textures/about/certs/claude-platform-101-cert.png' },
            { label: 'Case Block World', date: '2025', image: '/textures/about/certs/case-block-world-cert.png' },
            { label: 'Claude AI Fluency', date: '2025', image: '/textures/about/certs/claude-ai-fluency-cert.png' },
        ...
        <group ref={groupRef} position={[0, 2, z]}>
            ...
            <group ref={sotdRef} position={[0, 0.5, -0.5]}>
                ...
                <AwardButton
                    onClick={(e) => {
                        e.stopPropagation();
                        openOverlay(awardsData.certificates);
                    }}
                ...
                <Text
                    ...
                    font="/fonts/CabinSketch-Bold.ttf"
                >
                    {awardsData.certificates.items.length}
                </Text>
            </group>

            {/* === BADGES (behind SOTY, rendered third) === */}
            <group ref={sotmRef} position={[0, 0.5, -0.2]}>
                ...
                <Text
                    ...
                    font="/fonts/CabinSketch-Bold.ttf"
                >
                    {awardsData.badges.items.length}
                </Text>
            </group>
            ...
            <group ref={sotyRef} position={[0, 0.5, 0]}>
                ...
                <AwardButton
                    onClick={(e) => {
                        e.stopPropagation();
                        openOverlay(awardsData.sphere3d);
                    }}
                    texture={buttonTexture}
                    paintedTexture={buttonPaintedTexture}
                    width={buttonWidth}
                ...
                <Text
                    ...
                    font="/fonts/CabinSketch-Bold.ttf"
                >
                    {awardsData.sphere3d.items.length}
                </Text>
            </group>
        </group>
    );
